...
public class CameraCapturerCompat implements VideoCapturer {
    ...
    public CameraCapturerCompat(Context context, Source preferredCameraSource) {
    ...
    private String getAvailableCamera2Id(Source preferredCameraSource) {
        String preferredCamera2Id = camera2IdMap.get(preferredCameraSource);
        if (preferredCamera2Id != null) {
            return preferredCamera2Id;
        }

        return camera2IdMap.get(Source.switchCameraSource(preferredCameraSource));
    }

    private String getAvailableCamera1Id(Source preferredCameraSource) {
        String preferredCamera1Id = camera1IdMap.get(preferredCameraSource);
        if (preferredCamera1Id != null) {
            return preferredCamera1Id;
        }

        return camera1IdMap.get(Source.switchCameraSource(preferredCameraSource));
    }
